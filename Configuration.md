...
* **General settings**
  ...
  * **Sync Pebble Health/Misfit/Morpheus:** Which activity trackers you want to sync. Doesn't hurt to have options for Misfit/Morpheus turned on here if it's not installed. You'll only really need to disable things here when dealing with [[Multiple devices]].
* **Location**
