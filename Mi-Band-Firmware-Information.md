...
| ----------------------------- | --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- |
| recommended                   | ??? (when upgrading from 1.0.0.* versions, install version 1.0.0.53 (`Mili_pro_53.fw`) first)       | yes (when upgrading from 1.0.0.* versions, install version 1.0.0.53 (`Mili_pro_53.fw`) first)                               | yes (when upgrading from 1.0.0.* versions, install version 1.0.0.53 (`Mili_pro_53.fw`) first) | intermediate version needed to install newer firmware | yes                               | no      | no      |
