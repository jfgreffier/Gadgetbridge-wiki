...
| Version / Function            | 1.0.0.39                          | 1.0.0.19                          |
| ----------------------------- | --------------------------------- | --------------------------------- |
| recommended                   | yes                               | no                                |
| alarms                        | work                              | work (smart alarms partly)         |
| notifications                 | work                              | work                              |
| activity recognition          | works                             | step count inconsistent (most of the time) between GB and device itself |
| connection                    | works                             | works                             |
| battery life                  | good                              | good                              |
| heart rate measurement        | works                             | stopped working at some point (known firmware issue, not GB-related) |
