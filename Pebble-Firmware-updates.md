...
* Up or downgrade from From any 1.x/2.x firmware to any 1.x/2.x firmware.
* Up or downgrade from 3.x to any 3.x.

**WARNING: IF YOU WANT TO UPDATE your OG pebble to 3.x from 2.x, please do the following**
